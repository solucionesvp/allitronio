  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ── Programa — timeline ──────────────────────────────────────── */}
        <section id="programa" className="relative w-full bg-[var(--color-light)] px-8 py-24 lg:px-16 xl:px-24">
          <div className="mx-auto max-w-[840px]">
            ...
            <motion.p
              ...
              className="mt-5 max-w-[440px] font-body text-[0.85rem] leading-[1.8] text-secondary"
            >
            ...
            <div className="mt-14 flex flex-col">
              {EVENT_AGENDA.map((item, idx) => (
                <motion.div
                  ...
                  className="flex items-start gap-6 border-t border-[#101820]/10 py-7"
                >
                  <span className="w-14 shrink-0 font-display text-[0.85rem] font-black tabular-nums text-allitron-blue sm:w-16">
                    {item.time}
                  </span>
                  <div className="flex-1">
                    <div className="mb-2 flex flex-wrap items-center gap-3">
                      <span className="font-display text-[0.48rem] font-bold tracking-[0.28em] text-allitron-orange">
                        {AGENDA_KIND_LABEL[item.kind]}
                      </span>
                      {item.speakerKind && (
                        <span
                          className={`font-display text-[0.48rem] font-bold tracking-[0.2em] ${
                            item.speakerKind === "confirmada" ? "text-allitron-blue" : "text-secondary/70"
                          }`}
                        >
                    ...
                    <h3 className="font-display text-[0.95rem] font-bold text-[#101820]">
                      {item.title}
                    </h3>
                    <p className="mt-1.5 font-body text-[0.85rem] leading-[1.7] text-secondary">
                      {item.description}
                    </p>
                  </div>
                </motion.div>
              ))}
              <div className="border-t border-[#101820]/10" />
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-[1100px] items-center gap-12 lg:grid-cols-[0.9fr_1fr] lg:gap-16">
            ...
            <div className="order-1 lg:order-2">
              ...
              <motion.p
                ...
                className="mt-6 max-w-[440px] font-body text-[0.9rem] leading-[1.85] text-secondary"
              >
              ...
              <motion.p
                ...
                className="mt-4 font-display text-[0.68rem] font-bold tracking-[0.1em] text-secondary/70"
              >
        ...
        <section className="relative w-full bg-[var(--color-light)] px-8 py-24 lg:px-16 xl:px-24">
          <div className="mx-auto max-w-[900px] text-center">
            ...
            <motion.p
              ...
              viewport={{ once: true, margin: "-60px" }}
              transition={{ duration: 0.6, delay: 0.16, ease: EASE }}
              className="mx-auto mt-6 max-w-[520px] font-body text-[0.9rem] leading-[1.85] text-secondary"
            >
