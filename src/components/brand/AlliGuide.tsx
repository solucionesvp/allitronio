...
//
// Actualización (15 sep 2026): las 3 variantes ahora son arte real generado
// a partir del alli-primary.png oficial (referencia de personaje en
// Higgsfield) — ya no se derivan con filtros CSS sobre la imagen primary.
